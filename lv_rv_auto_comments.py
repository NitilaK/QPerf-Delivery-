...
def main():
    ...
    folder = r"C:\Users\320289802\OneDrive - Philips\Documents\Cardiac Perfusion\Data\PESA\Data5\S21010"
    ...
    for idx, slice_id in enumerate(sorted_slices):
        ...
        peak_lv_seed, peak_lv_ellipses = auto_detect_seed_point(peak_eq, debug=True, return_contours=True)
        peak_rv_seed = auto_detect_rv_seed_near_lv(peak_lv_seed, peak_lv_ellipses, debug=True)
