...
def main():
    ...
    # Select the seed frame at the 20th percentile
    ...
    if contours_lv:
        lv_contour = max(contours_lv, key=cv2.contourArea)  # largest contour
        lv_points = lv_contour.squeeze()                    # convert (N,1,2) → (N,2)
